    ...
    <div class="md-content">
        <section id="buy">
                    ...
                    <div class="step step-1">
                        <header>
                            <span>Step 1</span>
                            <h3>Boat Trip: Break the Barrier</h3>
                        ...
                        <div class="buy-content">
                            ...
                            <div id="thecharter">
                               <div>
                                ...
                                <div class="chartercheckbox"><input type="checkbox" id="charter"/>$425 (12 seats)</div>
                            </div>
                    ...
                    <div class="step step-2">
                        <header>
                            ...
                            <p>IMPORTANT: If you are a party of over 8 and require a departure time that is not listed please call 020 7928 8933.</p>
                        </header>
                        <div class="buy-content">
                    ...
                    <footer>
                        <p class="msj error"><span class="icon">Error. Please check your information and try again. </p>
                        <div class="grid">
