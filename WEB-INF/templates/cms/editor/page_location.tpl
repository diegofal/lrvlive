<form name="editor_form" action="{$smarty.server.PHP_SELF}?subpage_id={$smarty.get.subpage_id}" method="post">
  ...
  <tr>
	...
	{if !empty($smarty.get.subpage_id) || ($smarty.get.option==add)}
	  ...
	  <tr>
		<td valign="top" class="txt-tahoma"><strong>Left block 1: </strong></td>
		<td><textarea name="page_left_block1" rows="4" class="cell-100prc-multi">{$content.page_left_block1}</textarea>
		</td>
	  </tr>
	  <tr>
		<td valign="top" class="txt-tahoma"><strong>Left block 2: </strong></td>
		<td><textarea name="page_left_block2" rows="4" class="cell-100prc-multi">{$content.page_left_block2}</textarea>
		</td>
	  </tr>
