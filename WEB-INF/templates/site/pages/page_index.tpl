<section id="homepage">
    <div class="video-container">
        ...
        <video poster="content/img/poster.jpg" width="960" height="220" id="intro-video" loop autoplay>
        </video>
    </div>
    <div class="home-content">
        <div class="subheading">
            <h1>Start living the fastest, funniest and craziest trip ever</h1>
            <img src='content/img/home/fastest2.png' alt="Start living the fastest, funniest and craziest trip ever. Select your trip"/>
            <br>
            <img src='content/img/home/fastest-arrows.png' alt="select yours"/>
        </div>
        <section id="trips">
            <div class="slider-homepage slider center">
                ...
                <div class="trip">
                    <div>
                        ...
                        <div class="info">
                            <span>The London Eye <img src="content/img/arrow-mini.png"/> Canary Wharf <img src="content/img/arrow-mini.png"/> The London Eye</span>
                            <h3>Captain Kidd's Canary Wharf Voyage</h3>
...
{literal}
    ...
    <script type="text/javascript">
        twttr.conversion.trackPid('l5up8', { tw_sale_amount: 0, tw_order_quantity: 0 });</script>
    <noscript>
        ...
        <img height="1" width="1" style="display:none;" alt="" src="//t.co/i/adsct?txn_id=l5up8&p_id=Twitter&tw_sale_amount=0&tw_order_quantity=0" /></noscript>
{/literal}