...
<section id="detail" class="breakthebarrier">
    <div class="intro">
        ...
        <div class="facts-container">
            ...
            <div class="actions">
                ...
                <button class="btn btn-secondary md-trigger" voucherid="9" data-modal="modal-1"> buy gift voucher  </button>
            </div>
        </div>
    </div>
    <div class="grid content">
        ...
        <div class="col-3-6 first-column">
            ...
            <p>Boarding at St Katharine’s Pier in the shadow of the iconic Tower Bridge you set sail to a rousing “Best of British” soundtrack from iconic music to the unmistakable voices of Winston Churchill, Peggy Mitchell, Del Boy, Mayor of London Boris Johnson and many more.</p>
        ...
        <div class="col-2-6 third-column">
            <div class="thebox">
                ...
                <blockquote>
                    <p>"If you want to have a tour around the Thames, then do it in style and use London RIB Voyages!"</p>
