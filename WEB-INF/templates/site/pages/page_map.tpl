<section id="map">
    ...
    <div class="md-modal md-effect-11 modal-sitepoint" id="london-eye">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/point-london-eye.jpg" alt="London Eye" />
            </div>
            <div class="sitepoint-content">
                <div class="main">
                    ...
                    <h6>By tube</h6>
                    <p>The London Eye is located within easy walking distance from several London Underground stations: Waterloo, Embankment, Charing Cross and Westminster.<br>
                        Waterloo is the closest, about five minutes walking distance. Leave the station via "Exit 6" and follow signs for the Southbank and The London Eye.<br>
                        Embankment and Charing Cross stations are close together on the north side of the River Thames. Both tube stations are a ten minute walk to reach the London Eye. From the station, cross over Hungerford Bridge and head for The London Eye.</p>

                    <p>Westminster and Embankment are on the Circle and District line.</p>

                    <p>Westminster tube station is the closest station to Big Ben and the Houses of Parliament. From Westminster tube station, take exit one and follow signs for London Eye. Check journey details and service updates here for London Underground</p>

                    <h6>By rail</h6>
                    <p>The closest rail stations to The London Eye are Waterloo and Charing Cross. Waterloo is the closest, about five minutes walking distance. Leave the station via "Exit 6" and follow signs for Southbank and/or The London Eye.</p>
                    <p>Charing Cross is about a fifteen minute walk to the London Eye. Cross over Hungerford Bridge and head for The London Eye. Check journey details and service updates here for British Rail</p>

                    <h6>By bus</h6>
                    <p>Buses to The London Eye include the 211, 77 and 381. The London Eye is on most London sightseeing bus tours and on the RV1 route that connects the London Eye to the Tate Modern and Covent Garden. Check journey details and service updates here for London Buses</p>

                    <h6>By car</h6>
                    <p>We do not recommend driving into the city, however there are many public car parks in The London Eye area. The nearest one to use is on Belvedere Road.<br>
                        Please note that The London Eye is within the Congestion Charge Zone.</p>

                    <h6>By river</h6>
                    <p>You can also navigate to The London Eye's Pier by river, ideally The Thames Clippers. There are a number of services which stop off at The London Eye Millennium Pier, meaning you can travel here from the O2, Millbank, Bankside, Embankment, Blackfriars, London Bridge, Tower, Canary Wharf, Hilton Docklands, Masthouse Terrace, Greenwich, Royal Arsenal Woolwich, St. Katharine or Westminster Piers.<br>
                        For more information see our sightseeing around London page.</p>

                    <h6>Facilities</h6>
                    <p>The London Eye offers first class baby changing, disabled and male/female wc facilities for all London RIB Voyages customer.</p>

                    <h6>Tickets and check-in</h6>
                    <p>Check in at Boarding Gate1 (One), The London Eye Millennium Pier. This is the up-stream end of the London Eye pier nearest Westminster Bridge and Big Ben.<br>
                        A member of London RIB Voyage experienced team will look forward to meeting you 15 minutes before your allocated departure time.</p>

                </div>
                <div class="sitepoint-extra">
                    <h5>Where</h5>
                    <p>
                        Boarding Gate One, <br>
                        The London Eye<br>Millennium Pier,<br>
            ...
            <a href="#" class="md-close" onclick="javascript:$(document.querySelector('.md-overlay')).click();" >close</a>
        </div>
    </div>



    <div class="md-modal md-effect-11 modal-sitepoint" id="tower-bridge">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/point-tower-bridge.jpg" alt="Tower Bridge" />
            </div>
            <div class="sitepoint-content">
                <div class="main">
                    <span>Meeting point</span>
                    ...
                    <p>
                        Nestled in the shadow of the most iconic bridge on the river Thames today, our second impressive home in front of The Tower of London guarantees both convenience and another ‘wow’ factor. Head here for Break the Barrier.<br>
                        St Katharine Pier is situated on the outskirts of St Katharine Dock next to Tower Bridge on the north bank of the Thames and directly in front of the Guoman (Tower) Hotel
                    </p>

                    <h6>By tube</h6>
                    <p>
                        Eight minute walk from Tower Hill tube station with Circle and District Lines.<br>
                        Ten minute walk from Aldgate tube station with Circle and Metropolitan Lines.<br>
                        Seventeen minute walk from Liverpool Street Station with Central, Hammersmith and City Lines.<br>
                    </p>

                    <h6>By rail</h6>
                    <p>
                        Eight minute walk from Fenchurch Station.<br>

                        Fifteen minute walk from Canon Street Station.<br>

                        By Docklands Light Railway (head towards The Tower, then St Katharine Pier.<br>

                        Six minute walk from Tower Gateway, DLR (Tower Gateway Branch)<br>

                        Fifteen minute walk from Shadwell DLR (Bank Branch)<br>
                    </p>

                    <h6>By bus</h6>
                    <p>
                        Buses to St Katharine Dock include numbers 15, 25, 42, 78, 100 and RV1 route that connects to the Tate Modern and Covent Garden. The pier is a short walk from the dock, heading for the river.
                    </p>

                    <h6>By car</h6>
                    <p>We advise against driving to St Katharine Pier but there is a car park within walking distance in St Katharine Dock. City Quay Car Park located on Thomas More Street, just outside of the congestion zone.</p>

                    <h6>By river</h6>
                    <p>Three minute walk from Tower Pier with regular river bus public service.</p>

                    <h6>Tickets and check-in</h6>
                    <p>A member of London RIB Voyage experienced team will look forward to meeting you 15 minutes before your allocated departure time on the pier</p>

                </div>
                <div class="sitepoint-extra">
                    <h5>Where</h5>
                    <p>
                        St Katharine Pier<br>
                        St Katharine Way<br>
                        Tower Hamlets<br>
                        London<br>
                        E1W 1LD.<br><br>
    ...
    <div class="md-modal md-effect-11" id="site-0">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/londoneye.jpg" alt="London Eye" />
            </div>
            <div class="sitepoint-content">
                <h3>London Eye</h3>
                <p class="lead">
                    Or as we like to call it – home! This is where you'll be whizzing out on your London RIB Voyage, and we think it's the perfect base.  443 feet tall and 394 feet in diameter, the London Eye is the most successful tourist attraction in the UK, with 30 million people riding the London Eye since March 2000.
                </p>
                <p>Considering it began with a temporary 5-year planning permission, we think our neighbours have created an extraordinary bit of history! 32 pods represent the 32 boroughs that make up this city as a whole, each offering the awesome sight of London's famous skyline. The London Eye has become a centrepoint for New Years Eve celebrations and the firework displays as Big Ben chimes in the new year are unrivalled.</p>
                <p>Although a famous British landmark, the construction employed companies from all over Europe, including France, Germany, Italy, the Netherlands and Czech Republic, and there are now similar attractions all around the world – as far as Singapore – proving the universal appeal of this unique experience.</p>
            </div>
            <a href="#" class="md-close" onclick="javascript:$(document.querySelector('.md-overlay')).click();" >close</a>
        </div>
    </div>

    <div class="md-modal md-effect-11" id="site-1">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/parliament.jpg" alt="Houses of Parliament" />
            </div>
            <div class="sitepoint-content">
                <h3>Houses of Parliament</h3>
                <p class="lead">
                    The awesome Victorian façade of this English Gothic Perpendicular Architecture (now that's a mouthful!) is sure to take your breath away from our particular vantage point on the river.
                </p>
                ...
                <p>A record breaker in its day, the Victoria Tower opposite Big Ben was the largest stone square tower in the world when the Victorians built it – another example of their incredible feats of engineering, many of which you will see from your unique view in your very own speedboat!</p>
                <p>Home of the House of Lords and the House of Commons, there are over 3 miles of corridor inside – which must be why it takes so long to get anything done in government!</p>
            </div>
            <a href="#" class="md-close" onclick="javascript:$(document.querySelector('.md-overlay')).click();" >close</a>
        </div>
    </div>

    <div class="md-modal md-effect-11" id="site-2">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/detail-bigben.jpg" alt="Big Ben" />
            </div>
            <div class="sitepoint-content">
                <h3>The Big Ben</h3>
                <p class="lead">
                    The quintessential British landmark – Big Ben has been telling London the time since 31st May 1859. That&#39;s because it is not the tower that is named Big Ben, it is the huge 13.5 tonne bell within.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-3">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/cleopatra.jpg" alt="Cleopatra's Needle" />
            </div>
            <div class="sitepoint-content">
                <h3>Cleopatra's Needle</h3>
                <p class="lead">
                    Standing on the north bank of the Thames is one of the oldest things you will see in London (other than the river of course!). This is Cleopatra's needle.
                </p>
                <p>Dated at over 3500 years old, it was given as a present from the ruler of Sudan (named Mohammed Ali – no relation!) to Nelson for his part in the Battle of the Nile 1798.</p>
    ...
    <div class="md-modal md-effect-11" id="site-4">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/somerset.jpg" alt="Somerset House" />
            </div>
            <div class="sitepoint-content">
                <h3>Somerset House</h3>
                <p class="lead">
                    A rather nice place to live we think! Certainly for the Duke of Somerset who began building his dream palace in 1547.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-5">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/oxo.jpg" alt="OXO Tower" />
            </div>
            <div class="sitepoint-content">
                <h3>OXO Tower</h3>
                <p class="lead">
                    The OXO Tower looks rather elegant for an ex-power station. Today it is home to the glorious Harvey Nichols restaurant along the top floor and interesting boutique shops along the bottom.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-6">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/hms.jpg" alt="HMS President" />
            </div>
            <div class="sitepoint-content">
                <h3>HMS President</h3>
                <p class="lead">
                    The ship that now sits here on the Thames as a bar and venue hire has had a very covert past! This was a Q-Ship during WWI. Impressively, it is one of the only three surviving warships built by the Royal Navy for that conflict.
                </p>
                <p>Built specifically for anti-submarine warfare her successors evolved into today's frontline Frigates. As a Q-Ship it was an undercover ship. When submarine attacks on British merchant ships became a serious menace after 1916, the existing Flower-class minesweepers were transferred to convoy escort duty, and fitted with depth charges as well as 4.7-inch naval guns.</p>
    ...
    <div class="md-modal md-effect-11" id="site-7">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/stpauls.jpg" alt="St Paul's Cathedral" />
            </div>
            <div class="sitepoint-content">
                <h3>St Paul's Cathedral</h3>
                <p class="lead">
                    Well what can you say?! The masterpiece of the genius of Christopher Wren – the architect we traditionally thank for rebuilding London after the Great Fire of 1666, which destroyed two thirds of the medieval city.
                </p>
                <p>The blaze took down the old St Paul's on the same site, and it fell to Wren to build something bigger and better than ever before. We think he did a rather good job! Wren is today buried in the crypt he designed. Blink and you miss him though – a small square plaque on the floor. However it’s the crafty epitaph, "Reader, if you seek my monument, look around you" which gives Wren the last laugh!</p>
    ...
    <div class="md-modal md-effect-11" id="site-8">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/milleniumbridge.jpg" alt="Millennium Bridge" />
            </div>
            <div class="sitepoint-content">
                <h3>Millennium Bridge</h3>
                <p class="lead">
                    Designed as a 'Blade of Light' the Millennium Bridge was set to wow the country on its opening. Unfortunately it was destined for bad luck, opening 2 months late on 10th June 2000. 2 days later, it was closed. The bridge was suffering a phenomenon known as 'synchronous lateral excitation' which in English means it wobbled!
                </p>
                <p>The bridge was closed for a further 2 years before re-opening on 22nd Feb 2002, costing an extra £5million! Londoner's have affectionately nicknamed the crossing 'The Wobbly Bridge' (Londoner's are famously imaginative…) and is now a real highlight when visiting the city.</p>
                <p>It crosses at a point that now links the Tate Modern to St Paul's Cathedral and the views are outstanding.</p>
                <p>It has made a couple of notable appearances in films, featuring in the sixth instalment of the Harry Potter film franchise, where the bridge collapsed following an attack by Death Eaters. The Bridge also appeared in the 2014 Marvel Cinematic Universe film Guardians of the Galaxy during the climactic battle on Xandar.</p>
            </div>
            <a href="#" class="md-close" onclick="javascript:$(document.querySelector('.md-overlay')).click();" >close</a>
        </div>
    </div>

    <div class="md-modal md-effect-11" id="site-9">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/tate.jpg" alt="Tate Modern" />
            </div>
            <div class="sitepoint-content">
                <h3>Tate Modern</h3>
                <p class="lead">
                    The same 'Mr Tate' of 'Tate and Lyle' sugar fame opened the Tate Britain way back in the 1880's for his classical art collection. What is housed here in the old Bankside power-station is it's up to date younger brother, the Tate Modern".
                </p>
                <p>The Tate Modern is Britain's home of modern art and whether it's an unmade bed you are looking at or a Dali painting, the collection here boasts something for everyone. Free entry means it is a must-do on anyone's itinerary, making it the most visited modern art gallery in the world with around 4.7 million visitors every year!</p>
                <p>Designed by Giles Gilbert Scott (the man responsible for designing London’s famous red telephone box!), the new designers (Herzog & de Meuron) wanted to retain the original character. The huge turbine hall was turned into an enormous social space – a ‘space for people’. Measuring an impressive 35 metres high and 152 metres long it became a vast and dramatic entrance area with ramped access, as well as a display space for very large sculptural projects and installation art.</p>
            </div>
            <a href="#" class="md-close" onclick="javascript:$(document.querySelector('.md-overlay')).click();" >close</a>
        </div>
    </div>

    <div class="md-modal md-effect-11" id="site-10">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/shakespeare.jpg" alt="Shakespeare's Globe" />
            </div>
            <div class="sitepoint-content">
                <h3>Shakespeare's Globe</h3>
                <p class="lead">
                    Ah, Shakespeare's Globe, the only building in London today since the Great Fire of 1666 that is allowed by law a thatch roof in its construction.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-11">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/golden.jpg" alt="Golden Hinde" />
            </div>
            <div class="sitepoint-content">
                <h3>Golden Hinde</h3>
                <p class="lead">
                    The Golden Hinde sits next to Southwark Cathedral and is a ¾ size replica of the vessel that Sir Francis Drake sailed around the world on between 1597 and 1580. The first Englishman to ever circumnavigate the globe, he was knighted by Queen Elizabeth I on 4th April 1581. Celebrated by school syllabuses as hero of Elizabethan England!
                </p>
                <p>That is until you look closer. On his expedition he managed to 'acquire' £600,000 – which is many millions by today's standards. In fact, he cleared our national debt by stealing it from the rest of the world. Abroad he is a villain! Yet here, he's a bona fide British hero.</p>
                <p>Today the replica offers a glimpse into life on an Elizabethan sea vessel. Open for tours and educational experiences, it is a far cry from today's power-driven boats. The Golden Hinde was originally known as the Pelican and was renamed in mid-voyage (1577) by Drake as he prepared to enter the Straits of Magellan.</p>
            </div>
            <a href="#" class="md-close" onclick="javascript:$(document.querySelector('.md-overlay')).click();" >close</a>
        </div>
    </div>
    ...
    <div class="md-modal md-effect-11" id="site-12">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/londonbridge.jpg" alt="London Bridge" />
            </div>
            <div class="sitepoint-content">
                <h3>London Bridge</h3>
                <!-- <p class="lead">
                ...
                <p class="lead">The eponymous bridge of our city! London Bridge has stood on this site for nearly 2000 years. Not the prettiest bridge in London (which is probably why many visitors confuse London Bridge with the much more opulent Tower Bridge), but certainly one of the most important.</p>
                <p>The current bridge was completed fairly recently in 1973. However, surely the most spectacular bridge on this site was the medieval London Bridge. With shops, housing and even a chapel in the middle, the old London Bridge really was a town within a town! Built over a series of arches, the river below was forced through these creating severe river rapids. A popular (but hugely dangerous!) pastime was ‘shooting the bridge’ – only the brave or foolhardy attempted to steer their boats through on a flood tide, and many were drowned during the attempt. The bridge was "for wise men to pass over, and for fools to pass under."</p>
                <p>Today the modern London Bridge is a major pedestrian commuter route into the heart of the city. It is quite a sight at 5pm to see the city workers leaving and filling the bridge with suit after suit after suit. We certainly feel blessed when we cruise under during rush hour, sometimes modernising the old saying to ourselves, “the bridge is for wise men to pass under, and for fools to pass over!”</p>
            </div>
            <a href="#" class="md-close" onclick="javascript:$(document.querySelector('.md-overlay')).click();" >close</a>
        </div>
    </div>
    ...
    <div class="md-modal md-effect-11" id="site-13">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/monument.jpg" alt="Monument" />
            </div>
            <div class="sitepoint-content">
                <h3>Monument</h3>
                <p class="lead">
                    London is a city of survival. With 2000 years of human history it is inevitable that our capital was going to run into a few problems along the way.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-14">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/theshard.jpg" alt="The Shard" />
            </div>
            <div class="sitepoint-content">
                <h3>The Shard</h3>
                <p class="lead">
                ...
                <p>The broken top creates the impression of a huge shard of glass rising up out of the capital. The tallest building in Western Europe towers at 1016ft from base to tip. It's on the 72nd floor on the Shard's observation deck you can enjoy views as far as the North Sea over 50 miles away!</p>
    ...
    <div class="md-modal md-effect-11" id="site-15">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/billingsgate.jpg" alt="Old Billingsgate Fish Market" />
            </div>
            <div class="sitepoint-content">
                <h3>Old Billingsgate Fish Market</h3>
                <p class="lead">
                    The Old Billingsgate Fish Market was once the heart of trade in the City of London.
                </p>
                <p>
                    With fish on the weathervanes to distinguish it as the fish market, people would flock to get the best picks from the freshest catches. Famous workers include Michael Caine (then Maurice Micklewhite.) and the Kray twins! The beautiful arcaded market hall was built in 1875, but the market itself was moved to a new site on the Isle of Dogs in 1982. The building remains as one of London’s most beautiful landmarks with the best views from – you’ve guessed it – the river! It is now a listed building and used as a hospitality and events space.
                </p>
            </div>
            <a href="#" class="md-close" onclick="javascript:$(document.querySelector('.md-overlay')).click();" >close</a>
        </div>
    ...
    <div class="md-modal md-effect-11" id="site-16">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/hms-belfast.jpg" alt="HMS Belfast" />
            </div>
            <div class="sitepoint-content">
                <h3>HMS Belfast</h3>
                <p class="lead">
                    This is one of the most significant battle-ships of our recent history. It's 6th June 1944. 06.30 and as the sun rises one of the most important events of modern history is about to take place. It would become known as D-day. HMS Belfast was the largest ship in the British fleet and it's these guns, with a range of 12.5 miles, which started firing at Hitler's troops on that historic day.
                </p>
                ...
                <p>With over 250,000 visitors per year HMS Belfast has proved to be a hugely popular glimpse into a small part of this nation's rich maritime history.</p>
            </div>
            <a href="#" class="md-close" onclick="javascript:$(document.querySelector('.md-overlay')).click();" >close</a>
        </div>
    </div>
    ...
    <div class="md-modal md-effect-11" id="site-17">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/gherkin.jpg" alt="The Gherkin" />
            </div>
            <div class="sitepoint-content">
                <h3>The Gherkin</h3>
                <p class="lead">
    ...
    <div class="md-modal md-effect-11" id="site-18">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/gla.jpg" alt="GLA Building" />
            </div>
            <div class="sitepoint-content">
                <h3>GLA Building</h3>
                <p class="lead">
                    Another unusual design here, City Hall sits next to Tower Bridge on the edge of a larger development known as More London comprising of offices and shops. It is here that our most eccentric Englishman - Boris Johnson – cycles to work everyday.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-19">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/toweroflondon.jpg" alt="Tower of London" />
            </div>
            <div class="sitepoint-content">
                ...
                <p>The Tower has survived every major disaster in London and been in some way related to nearly every major event over its 1000 year lifetime. With a lifetime to last a millennium it is inevitably going to be used for a huge range of needs. The Tower has been home to the royal treasury, the royal mint, London Zoo, an armoury and a place of execution and torture, to name but a few. You will see the entry to the traitors gate from our RIB where the accused were brought to be imprisoned and eventually executed</p>
    ...
    <div class="md-modal md-effect-11" id="site-20">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/towerbridge.jpg" alt="Tower Bridge" />
            </div>
            <div class="sitepoint-content">
                <h3>Tower Bridge</h3>
                <p class="lead">
                    To see this bridge open in the centre archway for the first time in 1894 must have been an amazing sight.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-21">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/wappingpolice.jpg" alt="Wapping Police Station" />
            </div>
            <div class="sitepoint-content">
                <h3>Wapping Police Station</h3>
                <p class="lead">
                    This is the current home of the Wapping River Police, so please act naturally as we slow down to get past! They are the oldest police force on record dating from 1798!
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-22">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/canary.jpg" alt="Canary Wharf" />
            </div>
            <div class="sitepoint-content">
                <h3>Canary Wharf</h3>
                <p class="lead">
                    This is the other major financial district of London. Canary Wharf is home to some of the tallest buildings in the UK. These are the world or European headquarters of some of the worlds major banks, professional services firms and media organisations including Barclays, Citigroup, Clifford Chance, Credit Suisse, Fitch Ratings, HSBC, J.P. Morgan, KPMG, MetLife, Morgan Stanley, Skadden, State Street and Thomson Reuters.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-23">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/cutty.jpg" alt="Cutty Sark" />
            </div>
            <div class="sitepoint-content">
                <h3>Cutty Sark</h3>
                <p class="lead">
                    Here on the waterside at Greenwich sits one of the fastest clipper ships of the Victorian age. The opening of the Suez Canal in 1869 meant the race was on to transport tea – a highly sought after item - to Britain's shores.
                </p>
                ...
                <p>Opened by the Queen – a familiar ceremony as the Queen opened the 19th century tea clipper exhibit in 1957. Unusually the name 'Cutty Sark' is Scottish slang for 'short undergarments'! If you look carefully you may see the figurehead.</p>
    ...
    <div class="md-modal md-effect-11" id="site-24">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/green-univ.jpg" alt="Greenwich University" />
            </div>
            <div class="sitepoint-content">
                <h3>Greenwich University</h3>
                <p class="lead">
                    Welcome to the heart of Britain’s maritime history! Look at the glorious buildings of the Old Royal Naval College designed by none other than Christopher Wren (that bloke who designed St Paul's). Greenwich is a royal borough and it was on this site the Palace of Palentia once stood.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-25">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/green-village.jpg" alt="Greenwich Observatory" />
            </div>
            <div class="sitepoint-content">
                <h3>Greenwich Observatory</h3>
                <p class="lead">
                    Today Greenwich is famous as the home of the line of longitude that runs right through the observatory itself. In fact, you will pass from the western hemisphere to the eastern hemisphere with us! King Charles II commissioned the building in 1675 and also created the role of Astronomer Royal.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-26">
        <div class="md-content">
            ...
            <div class="sitepoint-content">
                ...
                <p>With many attractions inside including shops, restaurants, bars, exhibitions, Indigo at the O2 arena for more intimate gigs and a cinema you won’t be short of finding something to do in this area of Greenwich that has been completely reshaped by this celebration of the millennium.</p>
            </div>
            <a href="#" class="md-close" onclick="javascript:$(document.querySelector('.md-overlay')).click();" >close</a>
        </div>
    </div>

    <div class="md-modal md-effect-11" id="site-27">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/thames.jpg" alt="Thames Barrier" />
            </div>
            <div class="sitepoint-content">
                <h3>Thames Barrier</h3>
                <p class="lead">
                    The reason London is in existence (and London RIB Voyages for that matter!) is the river. No river, no London. It is how London has made money and grown by trading with Europe.
                </p>
    ...
    <div class="map-heading">
        <img src="content/img/map/meeting-points.png" alt="Meeting points" />
        <h1>Meeting points</h1>
        <p>Only London RIB Voyages offer speedboat adventures from both these iconic locations on the great river Thames … Are you ready?</p>
    </div>
    <div class="map-splash-title">
        <img src="content/img/map/splash-title.png" />
    </div>
    <div class="map-discover">
        <img src="content/img/map/discover.png" />
    </div>

    <div class="map-compass">
        <img src="content/img/map/compass.png" />
    </div>
    <div id="meeting-1" class="meeting-point">
        <h5>London Eye</h5>
        <img src="content/img/map/london-eye.png" />
        <div>
    ...
    <div id="meeting-2" class="meeting-point">
        <h5>Tower Bridge</h5>
        <img src="content/img/map/london-bridge.png" />
        <div>
    ...
    <img src="content/img/map/map-bg.jpg" alt="map" />


    <div class="md-overlay"></div>
    <div class="locations-container">
        <div id="map-locations" class="slider-map slider center">
            <div class="md-trigger" data-modal="site-0" alt="London Eye"><img src="content/img/map/thumb-londoneye.png" alt="London Eye"/></div>
            ...
            <div class="md-trigger" data-modal="site-7" alt="St Paul's Cathedral" ><img src="content/img/map/thumb-stpauls.png" alt="St Paul's Cathedral" /></div>
            <div class="md-trigger" data-modal="site-8" alt="Millennium Bridge" ><img src="content/img/map/thumb-milleniumbridge.png" alt="Millennium Bridge" /></div>
            <div class="md-trigger" data-modal="site-9" alt="Tate Modern" ><img src="content/img/map/thumb-tate.png" alt="Tate Modern" /></div>
            <div class="md-trigger" data-modal="site-10" alt="Shakespeare's Globe"><img src="content/img/map/thumb-shakespeare.png" alt="Shakespeare's Globe"/></div>
            <div class="md-trigger" data-modal="site-11" alt="Golden Hinde"><img src="content/img/map/thumb-golden.png" alt="Golden Hinde"/></div>
            <div class="md-trigger" data-modal="site-12" alt="London Bridge"><img src="content/img/map/thumb-londonbridge.png" alt="London Bridge"/></div>
            <div class="md-trigger" data-modal="site-13" alt="Monument"><img src="content/img/map/thumb-monument.png" alt="Monument"/></div>
            <div class="md-trigger" data-modal="site-14" alt="The Shard"><img src="content/img/map/thumb-theshard.png" alt="The Shard"/></div>
            <div class="md-trigger" data-modal="site-15" alt="Old Billingsgate Fish Market"><img src="content/img/map/thumb-billingsgate.png" alt="Old Billingsgate Fish Market"/></div>
            <div class="md-trigger" data-modal="site-16" alt="HMS Belfast"><img src="content/img/map/thumb-hmsbelfast.png" alt="HMS Belfast"/></div>
            <div class="md-trigger" data-modal="site-17" alt="The Gherkin"><img src="content/img/map/thumb-gherkin.png" alt="The Gherkin"/></div>
            <div class="md-trigger" data-modal="site-18" alt="GLA Building"><img src="content/img/map/thumb-gla.png" alt="GLA Building"/></div>
            <div class="md-trigger" data-modal="site-19" alt="Tower of London"><img src="content/img/map/thumb-toweroflondon.png" alt="Tower of London"/></div>
            <div class="md-trigger" data-modal="site-20" alt="Tower Bridge"><img src="content/img/map/thumb-towerbridge.png" alt="Tower Bridge"/></div>
            <div class="md-trigger" data-modal="site-21" alt="Wapping Police Station"><img src="content/img/map/thumb-wappingpolice.png" alt="Wapping Police Station"/></div>
            <div class="md-trigger" data-modal="site-22" alt="Canary Wharf" ><img src="content/img/map/thumb-canary.png" alt="Canary Wharf" /></div>
            <div class="md-trigger" data-modal="site-23" alt="Cutty Sark"><img src="content/img/map/thumb-cutty.png" alt="Cutty Sark"/></div>
            <div class="md-trigger" data-modal="site-24" alt="Greenwich University"><img src="content/img/map/thumb-green-univ.png" alt="Greenwich University"/></div>
            <div class="md-trigger" data-modal="site-25" alt="Greenwich Observatory"><img src="content/img/map/thumb-green-village.png" alt="Greenwich Observatory"/></div>
            <div class="md-trigger" data-modal="site-26" alt="O2 Arena"><img src="content/img/map/thumb-o2.png" alt="O2 Arena"/></div>
            <div class="md-trigger" data-modal="site-27" alt="Thames Barrier"><img src="content/img/map/thumb-thames.png" alt="Thames Barrier"/></div>
