<section id="map">
            ...
            <div class="sitepoint-content">
                ...
                <div class="sitepoint-extra">
                    ...
                    <p>
                        ...
                        The London Eye Millennium Pier<br>
            ...
            <div class="sitepoint-content">
                <div class="main">
                    ...
                    <p>
                        ...
                        By Docklands Light Railway (head towards The Tower, then St Katharine's Pier.<br>
                    ...
                    <h6>By car</h6>
                    <p>We advise against driving to St Katharine's Pier but there is a car park within walking distance in St Katharine's Dock. City Quay Car Park located on Thomas More Street, just outside of the congestion zone.</p>
    ...
    <div class="md-modal md-effect-11" id="site-3">
        <div class="md-content">
            <div class="sitepoint-image">
                <img src="content/img/map/cleopatra.jpg" alt="Cleopatras Needle" />
            </div>
            <div class="sitepoint-content">
    ...
    <div class="md-modal md-effect-11" id="site-7">
        <div class="md-content">
            ...
            <div class="sitepoint-content">
                ...
                <p class="lead">
                    Well what can you say?! The masterpiece of the genius of Christopher Wren – the architect we traditionally thank for rebuilding London after the Great Fire off 1666, which destroyed two thirds of the medieval city.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-8">
        <div class="md-content">
            ...
            <div class="sitepoint-content">
                ...
                <p class="lead">
                    Designed as a 'Blade of Light' the Millennium Bridge was set to wow the country on it's opening. Unfortunately it was destined for bad luck, opening 2 months late on 10th June 2000. 2 days later, it was closed. The bridge was suffering a phenomenon known as 'synchronous lateral excitation' which in English means it wobbled!
                </p>
                <p>The bridge was closed for a further 2 years before re-opening on 22nd Feb 2002, costing an extra £5million! Londoner's have affectionately nicknamed the crossing 'The Wobbly Bridge' (Londoner's are famously imaginitive…), and is now a real highlight when visiting the city.</p>
    ...
    <div class="md-modal md-effect-11" id="site-9">
        <div class="md-content">
            ...
            <div class="sitepoint-content">
                <h3>Tate Modern</h3>
                <p class="lead">
                    The same 'Mr Tate' of 'Tate and Lyle' sugar fame opened the Tate Britain way back in the 1880's for his classical art collection. What is housed here in the old Bankside powerstation is its up-to-date younger brother.
                </p>
    ...
    <div class="md-modal md-effect-11" id="site-11">
        <div class="md-content">
            ...
            <div class="sitepoint-content">
                <h3>Golden Hinde</h3>
                <p class="lead">
                    The Golden Hinde sits next to Southwark Cathedral and is an exact replica of the vessel that Sir Francis Drake sailed around the world on between 1597 and 1580. The first Englishman to ever circumnavigate the globe, he was knighted by Queen Elizabeth I on 4th April 1581. Celebrated by school syllabuses as a hero of Elizabethan England!
                </p>
    ...
    <div class="map-heading">
        ...
        <p>Only London RIB Voyages offer speedboat adventures from both these iconic locations on the river Thames.</p>
    </div>
