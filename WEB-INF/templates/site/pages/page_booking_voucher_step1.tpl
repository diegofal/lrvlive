...
<div class="step step-1">
	...
	<div class="buy-content">
		<ul>
			...
			<li><span>Name of sender:</span><input name="voucher_order_name" value="{$voucher_order.voucher_order_name}" maxlength="20" type="text"/></li>

			<li><span>Last Name of sender:</span><input name="voucher_order_lastname" value="{$voucher_order.voucher_order_lastname}" maxlength="20" type="text"/></li>
			...
			<li><span>Country of sender:</span>
