...
extension = 'png';
if ((browser.isIE4x||browser.isIE5x && !browser.isIE55)||(browser.isNS4x)||(browser.isOpera && browser.isWin && browser.versionMinor <= 5))
  extension = 'gif';

function png_init(id){
    img_src = document.getElementById(id).src;
    re = /\.[(\w+)]*$/gi;
    img = img_src.replace(re,'');
    document.getElementById(id).src = img+'.'+extension;
}