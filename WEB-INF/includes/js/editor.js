...
this.width =  "auto";
this.height = "auto";
this.bodyStyle = 'border:1px solid #C5C8CB;background-color: #FFFFFF; font-family: "Verdana"; font-size: x-small;';
this.imgURL = _editor_images;
this.debug  = 0;
...
this.btnList = {
    ...
    "backcolor":      ['BackColor',            'Back Color',         'editor_action(this.id)',  'ed_color_bg.gif'],
