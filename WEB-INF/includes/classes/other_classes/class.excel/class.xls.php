...
//class Spreadsheet_Excel extends PEAR {
class Spreadsheet_Excel {
	...
	// permite generarea unui fisier simplu xls (SCRIEREA INTR-UN FISIER XLS) :
	// -----------------------------------------------------------------------------------------
	var  $excel_data;      	// a buffer for store excel stream data
	var  $excel_filename;     // excel filename
	
	// Default constructor
	function ExcelGen($excel_filename='excelgen', $excel_wksheetname = '') {
	...
	// functie de CITIRE A FISIERULUI XLS :
	// -----------------------------------------------------------------------------------------
    function read($sFileName) {
