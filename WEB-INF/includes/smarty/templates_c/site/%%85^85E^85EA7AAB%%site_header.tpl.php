<?php /* Smarty version 2.6.25, created on 2015-06-21 15:51:49
         compiled from utils/site_header.tpl */ ?>
<!doctype html>
...
<header id="main-header">
    <div class="grid clearHeader">
        ...
        <nav class="col-4-6">
            ...
            <!-- <a href="index.php#trips"> trips </a> -->
            <a href="why-us.php"> why us? </a>
            <a href="crew.php"> crew </a>
            <a href="services.php"> services </a>
            <a href="map.php"> meeting points </a>
            <a href="safety.php"> safety </a>
            <a href="https://londonribvoyages.wordpress.com/" target="_blank"> blog </a>
    ...
    <ul class="select-trip-items">
        ...
        <li><button class="md-trigger" tourid="9" data-modal="modal-1"> Sunset Speed Boating </button></li>
    </ul>
</header>
