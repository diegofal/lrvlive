      ...
      <header id="main-header" class="mdl-layout__header">
        ...
        <div class="mdl-layout__header-row">
          ...
          <div class="mdl-layout-spacer"></div>
            ...
            <button id="booknow" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
              Book Now
            </button>
            <ul class="mdl-menu mdl-js-menu mdl-menu--bottom-right" for="booknow">
                ...
                <li class="mdl-menu__item"><a href="http://www.londonribvoyages.com/booking.php?tour_id=27&subpage=step1&mobile=y" target="_blank">Limehouse Blast</a></li>
            </ul>
        </div>
      </header>
